...
class PerturbedTopK_(nn.Module):
    def __init__(self, k: int, num_samples: int=500, sigma: float=0.05):
        super().__init__()
        self.num_samples = num_samples
        self.sigma = sigma
    ...
    def __call__(self, x):
        return PerturbedTopKFuntion_.apply(x, self.k, self.num_samples, self.sigma)

class PerturbedTopKFuntion_(torch.autograd.Function):
    @staticmethod
    def forward(ctx, x, k: int, num_samples: int=500, sigma: float=0.05):
        # input here is scores with (bs, num_patches)
        b, d = x.shape
...
class PerturbedTopK_1(nn.Module):
    def __init__(self, k: int, num_samples: int=500, sigma: float=0.05):
        super().__init__()
        self.num_samples = num_samples
        self.sigma = sigma
...
class PerturbedTopKFuntion_1(torch.autograd.Function):
    @staticmethod
    def forward(ctx, x, k: int, num_samples: int=500, sigma: float=0.05):
        # input here is scores with (bs, num_patches)
        b, d = x.shape
...
class PerturbedTopK_2(nn.Module):
    def __init__(self, k: int, num_samples: int=500, sigma: float=0.05):
        super().__init__()
        self.num_samples = num_samples
        self.sigma = sigma
...
class PerturbedTopKFuntion_2(torch.autograd.Function):
    @staticmethod
    def forward(ctx, x, k: int, num_samples: int=500, sigma: float=0.05):
        # input here is scores with (bs, num_patches)
        b, d = x.shape
...
class VisualTokenSelection_(nn.Module):
    def __init__(self, max_frames, embed_dim=512, topk=3):
        super().__init__()
        self.max_frames = max_frames
        self.score_predictor = PredictorLG_(embed_dim=embed_dim)
        self.topk_selector = PerturbedTopK_(topk)
...
class VisualTokenSelection_1(nn.Module):
    def __init__(self, max_frames, embed_dim=512, topk=3):
        super().__init__()
        self.max_frames = max_frames
        self.score_predictor = PredictorLG_1(embed_dim=embed_dim)
        self.topk_selector = PerturbedTopK_1(topk)
...
class VisualTokenSelection_2(nn.Module):
    def __init__(self, max_frames, embed_dim=512, topk=3):
        super().__init__()
        self.max_frames = max_frames
        self.score_predictor = PredictorLG_2(embed_dim=embed_dim)
        self.topk_selector = PerturbedTopK_2(topk)
